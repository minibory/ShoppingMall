...
public class QProduct extends EntityPathBase<Product> {
    ...
    public final NumberPath<Integer> productSalePrice = createNumber("productSalePrice", Integer.class);

    public final BooleanPath productSaleYn = createBoolean("productSaleYn");
